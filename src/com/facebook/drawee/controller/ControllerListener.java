 ...
 *
 * <p>
 * Controller id is passed to each of the listener methods which is useful for
 * debugging and instrumentation purposes where those events can then be
 * associated with a sequence. Subscriber is free to completely ignore this id,
 * as late callbacks and other such correctness issues are taken care of by the
 * controller itself.
 *
 * @param <INFO>
 *            image info type
...
public interface ControllerListener<INFO> {
	 ...
	 * <p>
	 * IMPORTANT: It is not safe to reuse the controller from within this
	 * callback!
	 * 
	 * @param id
	 *            controller id
