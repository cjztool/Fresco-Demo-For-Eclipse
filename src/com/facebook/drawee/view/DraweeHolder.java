 ...
 *
 * <p>
 * Drawee users, should, as a rule, use {@link DraweeView} or its subclasses.
 * There are situations where custom views are required, however, and this class
 * is for those circumstances.
 *
 * <p>
 * Each {@link DraweeHierarchy} object should be contained in a single instance
 * of this class.
 *
 * <p>
 * Users of this class must call {@link Drawable#setBounds} on the top-level
 * drawable of the DraweeHierarchy. Otherwise the drawable will not be drawn.
 *
 * <p>
 * The containing view must also call {@link #onDetach()} from its
 * {@link View#onStartTemporaryDetach()} and {@link View#onDetachedFromWindow()}
 * methods. It must call {@link #onAttach} from its
...
public class DraweeHolder<DH extends DraweeHierarchy> implements VisibilityCallback {
	...
	/**
	 * Creates a new instance of DraweeHolder that detaches / attaches
	 * controller whenever context notifies it about activity's onStop and
	 * onStart callbacks.
	 *
	 * <p>
	 * It is strongly recommended to pass a {@link ListenableActivity} as
	 * context. The holder will then also be able to respond to onStop and
	 * onStart events from that activity, making sure the image does not waste
	 * memory when the activity is stopped.
	 */
	...
	/**
	 * If the given context is an instance of FbListenableActivity, then
	 * listener for its onStop and onStart methods is registered that changes
	 * visibility of the holder.
	 */
	public void registerWithContext(Context context) {
		// TODO(T6181423): this is not working reliably and we cannot afford
		// photos-not-loading issues.
	 ...
	 *
	 * <p>
	 * The containing view must call this method from both
	 * {@link View#onFinishTemporaryDetach()} and
	 ...
	 * <p>
	 * The containing view must call this method from both
	 * {@link View#onStartTemporaryDetach()} and
	...
	public void onDraw() {
		...
		// something went wrong here; controller is not attached, yet the
		// hierarchy has to be drawn
