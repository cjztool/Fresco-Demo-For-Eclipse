...
/**
 * A Drawable that contains an array of other Drawables (layers). These are
 * drawn in array order, so the element with the largest index will be drawn on
 * top.
 *
 * <p>
 * Similar to android's LayerDrawable but it doesn't support adding/removing
 * layers dynamically.
 */
