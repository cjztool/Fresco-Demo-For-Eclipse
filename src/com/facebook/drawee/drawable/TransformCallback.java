...
/**
 * Callback that is used to pass any transformation matrix and the root bounds
 * from a parent drawable to its child.
 */
public interface TransformCallback {
	 ...
	 *
	 * @param transform
	 *            Matrix that is applied to the drawable by the parent
	 *            drawables.
	 */
