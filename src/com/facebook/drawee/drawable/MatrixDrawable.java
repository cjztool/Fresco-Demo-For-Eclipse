...
/**
 * Drawable that can adjust underlying drawable based on specified
 * {@link Matrix}.
 */
public class MatrixDrawable extends ForwardingDrawable {
	...
	// Matrix that is actually being used for drawing. In case underlying
	// drawable doesn't have
	 ...
	 * 
	 * @param drawable
	 *            underlying drawable to apply the matrix to
	 * @param matrix
	 *            matrix to be applied to the drawable
	 */
	...
	private void configureBounds() {
		...
		// In case underlying drawable doesn't have intrinsic dimensions, we
		// cannot set its bounds to
		// -1 so we use our bounds and discard specified matrix. In normal case
		// we use drawable's
