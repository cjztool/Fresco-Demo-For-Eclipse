...
/**
 * Drawable that automatically rotates the underlying drawable with a pivot in
 * the center of the drawable bounds based on a rotation angle.
 */
public class OrientedDrawable extends ForwardingDrawable {
	...
	/**
	 * Creates a new OrientedDrawable. The only rotation angles allowed are
	 * multiples of 90 or -1 if the angle is unknown.
	 */
