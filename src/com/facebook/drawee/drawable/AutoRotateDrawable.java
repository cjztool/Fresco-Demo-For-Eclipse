...
public class AutoRotateDrawable extends ForwardingDrawable implements Runnable {
	...
	/**
	 * Creates a new AutoRotateDrawable with given underlying drawable, interval
	 * and a clockwise rotation.
	 *
	 * @param drawable
	 *            underlying drawable to apply the rotation to
	 * @param interval
	 *            duration in milliseconds of one complete rotation
	 */
	...
	/**
	 * Creates a new AutoRotateDrawable with given underlying drawable and
	 * interval.
	 *
	 * @param drawable
	 *            underlying drawable to apply the rotation to
	 ...
	 *            duration in milliseconds of one complete rotation
	 * @param clockwise
	 *            defines whether the rotation is clockwise or not
	 */
	...
	/**
	 * Define whether the rotation is clockwise or not. By default is the
	 * rotation clockwise.
	 */
	 ...
	 *
	 * Ideally, we'd like to call this from the callback (i.e. {@code run()}),
	 * but if we do there's no place where we can call scheduleNextFrame() for
	 * the first time. As a tradeoff, we call this from draw(), which means
	 * scheduleNextFrame() could technically be called multiple times for the
