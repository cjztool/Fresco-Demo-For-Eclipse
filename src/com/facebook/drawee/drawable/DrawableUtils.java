...
public class DrawableUtils {
	 ...
	 * 
	 * @param to
	 *            drawable to copy properties to
	 * @param from
	 ...
	 * 
	 * @param drawable
	 *            Drawable on which to set the properties
	 * @param properties
	 *            wrapper around property values to set on the drawable
	 */
	 ...
	 * 
	 * @param drawable
	 *            drawable to set callbacks to
	 * @param callback
	 *            standard Android Drawable.Callback
	 * @param transformCallback
	 *            TransformCallback used by TransformAwareDrawables
	 */
