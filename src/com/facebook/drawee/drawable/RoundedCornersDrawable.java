...
public class RoundedCornersDrawable extends ForwardingDrawable implements Rounded {
	...
	public enum Type {
		...
		/**
		 * Clips the drawable to be rounded. This option is not supported right
		 * now but is expected to be made available in the future.
		 */
		CLIPPING
	}
	...
	/**
	 * Sets radii values to be used for rounding. Each corner receive two radius
	 * values [X, Y]. The corners are ordered top-left, top-right, bottom-right,
	 * bottom-left
	 *
	 * @param radii
	 ...
	 *
	 * @param overlayColor
	 *            the color to filled outside the rounded corners
	 */
	...
	public void draw(Canvas canvas) {
		...
		switch (mType) {
			...
			case OVERLAY_COLOR:
				...
				if (mIsCircle) {
					// INVERSE_EVEN_ODD will only draw inverse circle within its
					// bounding box, so we need to
