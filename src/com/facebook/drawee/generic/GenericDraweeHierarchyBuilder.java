 ...
 *
 * <p/>
 * This class does not do deep copies of most of the input parameters. There
 * should be one instance of the hierarchy per DraweeView, so that each
 * hierarchy has a unique set of drawables.
 */
public class GenericDraweeHierarchyBuilder {
	...
	/**
	 * Sets the duration of the fade animation. If not set, default value of
	 * 300ms will be used.
	 * 
	 * @param fadeDuration
	...
	/**
	 * Sets the placeholder image, with default scale type CENTER_INSIDE. If no
	 * placeholder is set, a transparent ColorDrawable will be used.
	 * 
	 * @param placeholderDrawable
	 *            drawable to be used as placeholder image
	 * @return modified instance of this builder
	 */
	...
	/**
	 * Sets the placeholder image and scale type. If no placeholder is set, a
	 * transparent ColorDrawable will be used.
	 * 
	 * @param placeholderDrawable
	 *            drawable to be used as placeholder image
	 * @param placeholderImageScaleType
	 ...
	 * 
	 * @param retryDrawable
	 *            drawable to be used as retry image
	 * @return modified instance of this builder
	 */
	 ...
	 *            drawable to be used as failure image
	 * @return modified instance of this builder
	 */
	 ...
	 * @param failureDrawable
	 *            drawable to be used as failure image
	 * @param failureImageScaleType
	 *            scale type for the failure image
	 * @return modified instance of this builder
	 */
	 ...
	 * 
	 * @param progressBarImage
	 *            drawable to be used as progressBar image
	 * @return modified instance of this builder
	 */
	 ...
	 * @param progressBarImage
	 *            drawable to be used as progressBar image
	 * @param progressBarImageScaleType
	 *            scale type for the progressBar image
	 * @return modified instance of this builder
	 */
	...
	/**
	 * Sets the scale type, and removes the transformation matrix, for the
	 * actual image. If scale type is not set, and nor is a transformation
	 * matrix, then the actual image will be drawn with scale type CENTER_CROP.
	 * 
	 * @param actualImageScaleType
	 *            scale type for the actual image
	 * @return modified instance of this builder
	 */
	...
	/**
	 * Sets the transformation matrix, and removes the scale type, for the
	 * actual image. If matrix is not set, then the image will be drawn without
	 * a matrix being applied to it.
	 * 
	 * @param actualImageMatrix
	 *            matrix for the actual image
	 * @return modified instance of this builder
	...
	/**
	 * Sets the focus point for the actual image. If scale type FOCUS_CROP is
	 * used, focus point will attempted to be centered within a view. Each
	 * coordinate is a real number in [0,1] range, in the coordinate system
	 * where top-left corner of the image corresponds to (0, 0) and the
	 * bottom-right corner corresponds to (1, 1).
	 * 
	 * @param focusPoint
	...
	/**
	 * Sets the backgrounds. Backgrounds are drawn in list order before the rest
	 * of the hierarchy and overlays. The first background will be drawn at the
	 * bottom.
	 * 
	 * @param backgrounds
	...
	/**
	 * Sets the overlays. Overlays are drawn in list order after the backgrounds
	 * and the rest of the hierarchy. The last overlay will be drawn at the top.
	 * 
	 * @param overlays
	 *            overlay drawables
	 * @return modified instance of this builder
