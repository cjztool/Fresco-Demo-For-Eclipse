 ...
 * <p>
 * The view forwards events to the controller. The controller controls its
 * hierarchy based on those events.
 */
public interface DraweeController {
	...
	/**
	 * For an animated image, returns an Animatable that lets clients control
	 * the animation.
	 * 
	 * @return animatable, or null if the image is not animated or not loaded
	 *         yet
	 */
